...
\begin{figure}[t]
    ...
    \begin{tikzpicture}
        ...
        P2$\rightarrow$ & $1$ & $4$ & \cellcolor[HTML]{FFCE93}$3$ & $5$ & $6$ & $2$ \\ \cline{2-7} 
        \end{tabular}};
        \node (hijos) at (8,0) {\begin{tabular}{l|c|c|c|c|c|c|}
            \cline{2-7}
            H1$\rightarrow$ & $1$ & $2$ & $3$ & $5$ & $6$ & $4$ \\ \cline{2-7} 
            H2$\rightarrow$ & $3$ & $5$ & $1$ & $4$ & $2$ & $6$ \\ \cline{2-7} 
            \end{tabular}};
        \draw[-to] (padres) -- (hijos) node[above,midway] {$1\leftrightarrow3$, $4\leftrightarrow5$,} node[below,midway] {$2\leftrightarrow6$};
    \end{tikzpicture}
